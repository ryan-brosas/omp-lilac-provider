...
export const resolveConfig = async (): Promise<HonchoExtensionConfig> => {
  ...
  return {
    ...
    searchLimit,
    toolPreviewLength,
    reasoningLevel: process.env.HONCHO_REASONING_LEVEL || DEFAULT_REASONING_LEVEL,
    reasoningLevelCap: process.env.HONCHO_REASONING_LEVEL_CAP || DEFAULT_REASONING_LEVEL_CAP,
    ...
    observationMode: process.env.HONCHO_OBSERVATION_MODE === 'selective' ? 'selective' : 'unified',
  };
};
